...
import static pages.Main.clickDropDownListClaims;
import static pages.Main.clickDropDownListNewInBlock;
import static pages.Main.clickDropDownListNews;
import static pages.Main.getMainElementsButtonAllNews;
import static pages.Main.getMainElementsButtonClaims;
import static standby.WaitingMode.nestedScrollTo;
...
public class MainSteps {
    ...
    public static void clickButtonAllNews(){
        Allure.step("Нажать на  All News");
    ...
    public static void clickButtonClaims(){
        Allure.step("Нажать на кнопку All Claims");
    ...
    public static void clickDDListNews(){
        Allure.step("Скрытие  и раскрытие новостной ленты");
    ...
    public static void clickDDListNewInBlock(){
        Allure.step("Развертывание описания новости");
    ...
    public static void clickDDListClaims(){
        Allure.step("Скрытие  и раскрытие ленты с притензиями");
